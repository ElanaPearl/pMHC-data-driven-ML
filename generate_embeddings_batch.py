...
def generate_embeds(args):
    ...
    directory = './active_learning/data/'
    file_list = []
    ...
    manual_ckpts = ["./ckpt/AL_n10k_v1_random_balanced_sample1000_pw20_ckpt_e199.pth", "./ckpt/AL_n10k_v1_random_posOnly_sample1000_pw15_ckpt_e199.pth",
                    "./ckpt/AL_n10k_v1_leastCertain_balanced_sample1000_pw15_ckpt_e199.pth",
                    './ckpt/AL_pw5_n10k_v1_trustScore_leastcertain_balanced_sample5000_ckpt_e199.pth',
                    './ckpt/AL_s41_n10k_v1_trustScore_leastcertain_balanced_sample10000_ckpt_e199.pth'] 
    for name in manual_ckpts:
